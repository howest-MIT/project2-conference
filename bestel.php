...
<main>
    <section id="create" class="container">
        <h1>Nieuw Ticket</h1>
        <form method="post" action="bestel-verwerk.php" class="form">
    ...
    <select class="form-control" id="Amount">
      ...
      <option>15</option>
            ...
            <a href="bestel-verwerk.php"><input type="submit" name="submit" class="btn btn-default c-btn" value="Create"></input></a>
    </section>
</main>
