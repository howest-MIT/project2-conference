        ...
        <div class="form-group mt-2">
          <select class="form-control" id="sel1">
			...
			<div class="form-group">
                ...
                <select class="form-control" name="naam" id="naam">
                   <?php
                        foreach($arrTickets as $ticket){
                            echo "<option value='$ticket->naam'>$ticket->naam</option>";
                        }
                   ?>
                </select>
            </div>
            <div class="form-group">
                ...
                <select class="form-control" name="vn" id="vn">
                   <?php
                        foreach($arrTickets as $ticket){
                            echo "<option value='$ticket->voornaam'>$ticket->voornaam</option>";
                        }
                   ?>
                </select>
            </div>
			<div class="form-group">
                ...
                <select class="form-control" name="email" id="email">
                   <?php
                        foreach($arrTickets as $ticket){
                            echo "<option value='$ticket->email'>$ticket->email</option>";
                        }
                   ?>
                </select>
            </div>
            <div class="form-group">
                ...
                <select class="form-control" name="postcode" id="postcode">
                   <?php
                        foreach($arrTickets as $ticket){
                            echo "<option value='$ticket->postcode'>$ticket->postcode</option>";
                        }
                   ?>
                </select>
            </div>
            ...
            <a href="tickets.html"><input type="submit" name="submit" class="btn btn-default c-btn" value="Create"></input></a>
        </form>
    </section>
</main>
...
<div class="c-footer">
    <div class="container mt-5">
        <div class="row">
            <div class="col-sm-2 c-footertext"></div>
            <div class="col-sm-2 c-footertext text-center">Hogeschool
                Howest<br/>
                Marksesteenweg 58<br/> 8500 Kortrijk</div>
            <div class="col-sm-2 c-footertext"></div>
            <div class="col-sm-2 c-footertext">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</div>
            
            <div class="col-sm-2 c-footertext"></div>
            <div class="col-sm-2 c-footertext"><svg aria-hidden="true" color="white" focusable="false" data-prefix="c-fab" data-icon="facebook" class="svg-inline--fa fa-facebook fa-w-16 mt-3" height="30px" width="30px" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M504 256C504 119 393 8 256 8S8 119 8 256c0 123.78 90.69 226.38 209.25 245V327.69h-63V256h63v-54.64c0-62.15 37-96.48 93.67-96.48 27.14 0 55.52 4.84 55.52 4.84v61h-31.28c-30.8 0-40.41 19.12-40.41 38.73V256h68.78l-11 71.69h-57.78V501C413.31 482.38 504 379.78 504 256z"></path></svg>
