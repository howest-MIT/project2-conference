...
const getTalkById = function(id) {
  ...
  handleData(`http://api.laprudence.be/project2/v2/talks/${talkID}`, showTalkById);
}
...
<div class="container">
  <div class="row">
    <div class="col-sm-4"></div>
    <div class="col-sm-2 c-detailtext"><p>"${voornaam}${naam}"</p></div>
...
<div class="container">
  <div class="row">
    <div class="col-sm-4"></div>
    <div class="col-sm-2">${data.omschrijving.eng}</div>
    <div class="col-sm-4"></div>
    <div class="col-sm-2"></div>
  </div>
</div>
