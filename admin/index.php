...
<body>
    ...
    <nav class="c-navbar navbar-expand-md navbar-dark mb-5 pb-3">
        ...
        <div class="collapse navbar-collapse justify-content-center" id="collapsibleNavbar">
          <ul class="navbar-nav ">
            ...
            <li class="nav-item">
              <a class="nav-link " href="../project2-conference/../index.html">Home</a>
            </li>
            <li class="nav-item">   
    ...
    <section id="overview" class="container">
        <h1 class="mb-4 mt-4 c-titel">Overview</h1>
...
foreach($arrTickets as $ticket) {
    ...
    echo "<td><a href='../delete-verwerk.php?ticketid=".$tempid."'>delete</a>  - <a href='ticket-update.php?ticketid=".$tempid."'>edit</a> </td>";
    echo "</tr>";
